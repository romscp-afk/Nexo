-- Promote romscp@gmail.com to admin — run AFTER the user exists in Authentication.
...
SELECT user_id::text, email, role FROM profiles WHERE lower(email) = 'romscp@gmail.com';
