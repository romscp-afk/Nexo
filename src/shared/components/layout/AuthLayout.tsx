  ...
  if (native) {
    return (
      <div className="flex min-h-dvh flex-col bg-brand-bg">
        <header className="border-b border-brand-border bg-white pt-[env(safe-area-inset-top)]">
          <div className="flex h-12 items-center px-4">
            <Logo to="/" size="sm" />
          </div>
        </header>
        <main className="mx-auto w-full max-w-lg flex-1 px-4 py-6 pb-[calc(4.25rem+env(safe-area-inset-bottom))]">
          <Outlet />
        </main>
        <NativeGuestNav />
      </div>
